pub extern fn is_valid_path(test_string: ?[*]const u8) c_int;
pub extern fn is_valid_tag(test_string: ?[*]const u8) c_int;
pub extern fn is_valid_location(test_string: ?[*]const u8) c_int;
