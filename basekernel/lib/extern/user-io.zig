pub extern fn printf_putchar(c: u8) void;
pub extern fn printf_putstring(s: ?[*]u8) void;
pub extern fn draw_window(wd: c_int) void;
pub extern fn draw_color(r: c_int, g: c_int, b: c_int) void;
pub extern fn draw_rect(x: c_int, y: c_int, w: c_int, h: c_int) void;
pub extern fn draw_clear(x: c_int, y: c_int, w: c_int, h: c_int) void;
pub extern fn draw_line(x: c_int, y: c_int, w: c_int, h: c_int) void;
pub extern fn draw_char(x: c_int, y: c_int, c: u8) void;
pub extern fn draw_string(x: c_int, y: c_int, s: ?[*]u8) void;
