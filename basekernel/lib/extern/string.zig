...
pub extern fn strcpy(d: ?[*]u8, s: ?[*]const u8) void;
pub extern fn strncpy(d: ?[*]u8, s: ?[*]const u8, length: c_uint) void;
pub extern fn strcmp(a: ?[*]const u8, b: ?[*]const u8) c_int;
pub extern fn strncmp(a: ?[*]const u8, b: ?[*]const u8, length: c_uint) c_int;
pub extern fn strlen(s: ?[*]const u8) c_uint;
pub extern fn strcat(d: ?[*]u8, s: ?[*]const u8) ?[*]u8;
pub extern fn uint_to_string(u: u32, str: ?[*]u8) ?[*]u8;
pub extern fn strrev(s: ?[*]u8) ?[*]u8;
pub extern fn strtok(s: ?[*]u8, delim: ?[*]const u8) ?[*]u8;
pub extern fn str2int(s: ?[*]const u8, d: ?[*]c_int) c_int;
pub extern fn strchr(s: ?[*]const u8, ch: u8) ?[*]const u8;
pub extern fn memset(d: ?*c_void, value: u8, length: c_uint) void;
pub extern fn memcpy(d: ?*c_void, s: ?*const c_void, length: c_uint) void;
pub extern fn printf(s: ?[*]const u8, args:...) void;
